...
(function() {
  var body, bulbsTpl, createBridgeUser, dashboardTpl, defaultState, doAjaxRequest, doEffect, effectsTpl, favoritesTpl, hueIP, hueUser, init, lightList, renderBulbs, renderDashboard, renderEffects, renderFavorites, screen, selectBulb, timer, title, turnDefault, turnDefaultAll, turnOff, turnOffAll, turnOn, turnOnAll;
